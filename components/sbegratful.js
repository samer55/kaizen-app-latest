...
class SBegratful extends Component {
  constructor(props) {
    super(props);
    this.state = {
   ...
   hideDateTimePicker = () => {
     ...
     getRef() {
       ...
       const name = this.props.appStore.username
        ...
        return  firebaseApp.database().ref('gratful/'+ `/${name}/` + `/${uid}/`);
      }
...
<Text style={{fontSize:12,fontWeight:'500',color:'red'}}>Be Gratful</Text>
</TouchableOpacity>
</Right>
</CardItem>
<CardItem  button onPress={() => {
