...
export default {
  ...
  spendingsLastMonth: [
    {"number":  8, "name": 'Family'},
    {"number": 7, "name": 'Business/career'},
    {"number": 16, "name": 'Spirtual'},
    {"number": 23, "name": 'Body'},
    {"number": 42, "name": 'Mind/Emotion'},
    {"number":  4, "name": 'Money/Finance'},
    {"number": 10, "name": 'Relationship'},

    {"number": 12, "name": 'Social/Friends/Fun'},
