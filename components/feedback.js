...
class Feedback extends Component {
  ...
  state = {
    selected: '',isDateTimePickerVisible: false,selectedDate: "",feed:'',rating:1,
  }
  showActionSheet = () => {
  ...
  _simpleAlertHandler=()=>{
   ...
   alert('Thank you for your feed back');
    ...
    var dt = date;
      ...
      const newPostKey = firebaseApp.database().ref('feedback/').push().key
...
const WATER_IMAGE = require('./airbnb-star.png')
        return (
 ...
 onChangeText={tweet => this.setState({ feed: tweet })}
                            bordered placeholder=" We Value Your Opinion, Our Mission Is To Do The Best To Create A Path For Your Successful Journey To Be Easier  " />
                         </Form>
                         <Rating
                           showRating
 onFinishRating={(rating)=>  this.setState({ rating: rating })}
                            style={{ paddingVertical: 10,borderColor: 'white'}}
                         />

             <Button onPress={this.goals} primary bordered style={{justifyContent:'center',alignItems: 'center',padding: 25,alignSelf: 'center'}}  >
